...
async function obtenerProyectos(idUser) {
  try {
    const response = await fetch(`/obtener-proyectos-usuarios/${idUser}`);
...
timeInputs.forEach(function(input) {
  ...
  const proyectos = await obtenerProyectos(idUser);
  proyectos.forEach(proyecto => {
    const option = document.createElement('option');
...
proyectosSelect.addEventListener('change', async () => {
  ...
  console.log('Id Proyecto desde Proyectos Select: ',idProyecto)
  ...
  if (todosInasistencia) {
    ...
    .then(async data => {
      ...
      .then(async data => {
          ...
          console.log('Detalle Asistencia: ',detallesAsistencia);
        ...
        await Swal.fire({
          ...
          icon: 'success'
            ...
            console.log('Fecha Asistencia: ',fechaAsistencia);
            console.log('ID Asistencia Cuadrilla: ',idAsistenciaCuadrilla);
